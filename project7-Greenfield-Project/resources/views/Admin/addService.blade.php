            ...
            <div class="col-lg-8">
                <div class="card">
                    ...
                    <div class="card-body" style="background: white; padding: 3rem">
                        ...
                        @endif
                        <form action="/admin/manageService" method="post" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            <div class="form-group">
                                <label for="service_name" class="control-label mb-1">Service Name</label>
                                <input  name="service_name" type="text" class="form-control" value="{{old('service_name')}}">
                            ...
                            <div class="form-group">
                                ...
                                <input  name="service_price" type="number" class="form-control" value="{{old('service_price')}}">
